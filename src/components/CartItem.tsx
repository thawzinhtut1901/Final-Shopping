      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          <div className="flex justify-between mb-2">
            ...
            <div className="text-xl cursor-pointer" onClick={() => removeFormCart(id)}><IoMdClose className="text-gray-500 hover:text-red-500 transition"/></div>
          </div>

          <div className=" flex gap-x-2 h-[36px] text-sm">
            <div className="flex flex-1 max-w-[100px]  items-center h-full border text-zinc-950 font-medium">
            ...
            <div className="flex-1 flex justify-end items-center text-zinc-900 font-medium">{`$ ${(price * amount).toFixed(2)}`}</div>
          </div>
